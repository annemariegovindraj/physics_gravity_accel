...
addMouseListener(this);
 Image correctimg=getImage(getCodeBase(), "tick.gif"); Image wrongimg=getImage(getCodeBase(), "cross.gif");
...
String inLine=null; InputStreamReader instream =null;
 try{ 
 instream= new InputStreamReader(getClass().getResourceAsStream("mytext.txt"));
